...
class RbacController extends Controller {
    ...
    private static $_permissions = [
        ...
        ['name' => 'pricelist_list', 'description' => 'Просмотр прайслистов второй версии'],
        ...
        ['name' => 'header_list', 'description' => 'Просмотр списка Header'],
        ...
        ['name' => 'major_group_list', 'description' => 'Просмотр списка групп ННП-фильтров'],
        ...
        ['name' => 'sms_test_group_list', 'description' => 'Просмотр списка SMS групп тестов'],
        ['name' => 'sms_test_group_create', 'description' => 'Создание SMS группы тестов'],
        ['name' => 'sms_test_group_edit', 'description' => 'Редактирование SMS группы тестов'],
        ['name' => 'sms_test_group_delete', 'description' => 'Удаление SMS группы тестов'],
        ['name' => 'sms_test_auth_list', 'description' => 'Просмотр списка SMS тестов маршрутизации'],
        ['name' => 'sms_test_auth_create', 'description' => 'Создание SMS теста маршрутизации'],
        ...
        ['name' => 'billing_servers_list', 'description' => 'Просмотр раздела биллинговых серверов'],
        ['name' => 'billing_servers_edit', 'description' => 'Редактирование настроек биллинговых серверов'],
    ];
    ...
    private static $_rolePermissions = [
        ['role' => 'superadmin', 'permissions' => [
            ...
            'sms_test_group_delete', 'sms_test_auth_list', 'sms_test_auth_create', 'sms_test_auth_edit', 'sms_test_auth_delete',  'corm_edit', 'network_list', 'network_edit', 'billing_servers_list', 'billing_servers_edit'
        ]],
        ['role' => 'admin_billing', 'permissions' => [
            ...
            'pricelist_search', 'old_pricelist_search', 'action_log_view', 'pricelist_filter_b_history_list', 'billing_servers_list', 'billing_servers_edit'
        ]],
        ...
        ['role' => 'admin_sms', 'permissions' => [
            ...
            'number_edit', 'major_group_list', 'major_group_delete', 'major_group_edit', 'major_group_create', 'trunk_list', 'sms_test_group_list', 'sms_test_group_create', 'sms_test_group_edit',
            'sms_test_group_delete', 'sms_test_auth_list', 'sms_test_auth_create', 'sms_test_auth_edit', 'sms_test_auth_delete', 
    ...
    private static function getPermissions($roleName)
    {
        foreach (self::$_rolePermissions as $rolePermission)
        {
            if ($rolePermission['role'] === $roleName) {
    ...
    public static function getBillingPermissions()
    {
        return self::getPermissions('admin_billing');
    }
    ...
    public function actionInit() {
        ...
        $adminRouting = $auth->getRole('admin_routing');
//        $adminBilling = $auth->getRole('admin_billing');
        $engineer = $auth->getRole('engineer');
        $manager = $auth->getRole('manager');
        
        $auth->assign($adminRouting, 102);
        
        $auth->assign($superAdmin, 116);
        $auth->assign($superAdmin, 123);
