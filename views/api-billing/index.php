...
?>
                ...
                var apiBillingPermissions = <?= json_encode($apiBillingPermissions, JSON_UNESCAPED_UNICODE + JSON_UNESCAPED_SLASHES); ?>;
            ...
            <div ng-controller="MainApiBillingCtrl" ng-include="'/templates/main_api_billing.html'"></div>
