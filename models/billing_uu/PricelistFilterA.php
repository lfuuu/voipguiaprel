...
class PricelistFilterA extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['nnp_destination', 'nnp_country', 'nnp_operator', 'nnp_region', 'nnp_city', 'nnp_ndc_type'], 'string'],
    ...
    public function getFilterB()
    {
        return $this->hasMany(PricelistFilterB::className(), ['pricelist_filter_a_id' => 'id'])
            ->select(['billing_uu.pricelist_filter_b.*', 'c.nnp_country_name', 'd.nnp_destination_name', 'o.nnp_operator_name', 'r.nnp_region_name', 'cty.nnp_city_name', 't.nnp_ndc_type_name'])
