...
class Server extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['low_balance_outcome_id', 'blocked_outcome_id', 'hub_id', 'emergency_prefixlist_id', 'mcn_prefixlist_id','rc_mgmn_outcome_id','vats_trunk_id', 'ast_trunk_group_id'], 'integer'],
