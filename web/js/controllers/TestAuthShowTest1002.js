var TestAuthShowTest1002Ctrl = function($scope, TestAuth, params, $modalInstance) {

    $scope.details = 1;
    $scope.type = 'Test1002';

    if (params.id) {
        TestAuth.result({id: params.id, is1002: true, displayTreeView: true}).then(function (data) {
