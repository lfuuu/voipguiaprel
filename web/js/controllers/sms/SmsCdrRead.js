var SmsCdrReportReadCtrl = function($rootScope, $scope, SmsCdr, List, Redirect, $window) {
    ...
    // Обработка клика по строке таблицы для перехода к детальной информации
