var TestAuthShowTest1001Ctrl = function($scope, TestAuth, params, $modalInstance) {

    $scope.details = 1;
    $scope.type = 'Test1001';

    if (params.id) {
        TestAuth.result({id: params.id, is1001: true, displayTreeView: true}).then(function (data) {
