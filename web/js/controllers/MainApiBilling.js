app.controller('MainApiBillingCtrl', function ($rootScope, $scope, $cookies, $timeout, $modal, Redirect) {
    $rootScope.server = dataServer;
    $rootScope.userName = userName;
    $rootScope.userId = userId;
    $rootScope.userPermissions = userPermissions;
    $rootScope.apiBillingPermissions = apiBillingPermissions;
    $rootScope.isApiBilling = true;
    ...
    if (query) {
        ...
        id = params[1];
        type = params[2];
    } else if ($cookies.api_billing_selected_page !== undefined) {
        funcName = $cookies.api_billing_selected_page;
    } else {
