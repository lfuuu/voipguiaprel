var TestCallShowTest1002Ctrl = function($scope, TestCall, params, $modalInstance) {

    $scope.details = 1;
    $scope.type = 'Test1002';

    if (params.id) {
        TestCall.result({id: params.id, is1002: true, displayTreeView: true}).then(function (data) {
