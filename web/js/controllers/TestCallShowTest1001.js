var TestCallShowTest1001Ctrl = function($scope, TestCall, params, $modalInstance) {

    $scope.details = 1;
    $scope.type = 'Test1001';

    if (params.id) {
        TestCall.result({id: params.id, is1001: true, displayTreeView: true}).then(function (data) {
