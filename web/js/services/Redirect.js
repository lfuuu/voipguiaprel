app.factory('Redirect', function ($window, $rootScope, $modal, $cookies) {
    ...
    return {
        ...
        networkNode: function() {
            $cookies.network_selected_page = 'networkNode';
        ...
        networkLink: function() {
            $cookies.network_selected_page = 'networkLink';
            return openTab(NodesLinkListCtrl, '/templates/network/node_link_list.html');
        },

        linkCreate: function() {
            return openModal(NodeLinkEditCtrl, '/templates/network/node_link_edit.html', { node_link_id: null });
        },
        ...
        pricelistLocationCreate: function (id, pricelistIsActive, serviceTypeId) {
  return openModal(
    PricelistLocationEditCtrl,
    '/templates/pricelist_location_edit.html',
    {
      pricelist_id: id,
      pricelist_is_active: pricelistIsActive,
      pricelist_service_type_id: serviceTypeId
    }
  );
},
...
testSmsPricelistShowTestDev: function (id) {
  return openModal(
    ...
    { id: id }
        ...
        prefixlistByCamelSharedEdit: function(id) {
            return openModal(PrefixlistEditCtrl, '/templates/prefixlist_edit.html', {id: id});
        },
        ...
        pricelistFilterBHistoryView: function(id) {
            return openModal(PricelistFilterBHistoryViewCtrl, '/templates/billing/pricelist_filter_b_history_view.html', {id: id});
        },
        ...
        pricelistInCommerceViewPackage: function(item) {
            return openModal(PricelistInCommercePackageCtrl, '/templates/billing/pricelist_in_commerce_package.html', {id: item.id, item: item});
        },
